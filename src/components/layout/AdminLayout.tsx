...
const ALL_MODULES: NavItem[] = [
  ...
  { label: 'Lead Gen System',        href: '/crm',              icon: MapPin,          desc: 'Google Maps scraper & outreach',       color: 'text-green-400', badge: 'v2.1' },
  { label: 'Lead Analytics',         href: '/crm',              icon: BarChart2,       desc: 'Pipeline & funnel metrics',            color: 'text-indigo-400' },
